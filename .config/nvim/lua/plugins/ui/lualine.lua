    ...
    local opts = {
      ...
      sections = {
        ...
        lualine_c = {
          ...
          { 'diagnostics', symbols = icons.diagnostics, color = { error = '#ec5f67', warn = '#fac863', info = '#5fb3b3', hint = '#737aa2' } },
          { 'filetype', icon_only = true, separator = '', padding = { left = 1, right = 0 } },
          { 'filename', path = 1, shorting_target = 40, symbols = { modified = ' ●', readonly = ' ', unnamed = '[No Name]' } },
        },
        lualine_x = {
          {
            function()
          ...
          },
          {
            ...
            color = function()
              return { fg = package.loaded['snacks'] and require('snacks').util.color 'Statement' or '#7aa2f7' }
            end,
          },
          {
            function()
            ...
            color = function()
              return { fg = package.loaded['snacks'] and require('snacks').util.color 'Constant' or '#bb9af7' }
            end,
          },
          {
            function()
            ...
            color = function()
              return { fg = package.loaded['snacks'] and require('snacks').util.color 'Debug' or '#ff9e64' }
            end,
          },
          {
            function()
